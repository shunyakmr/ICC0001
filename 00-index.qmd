...
We created this moduel at the ICC because many of the resources available today on videos and booklets can be a bit overwhelming.
...
The topics covered over the next seven weeks are:

| Week | Section | Topic |
|------------------------|:-----------------------|:-----------------------|
| 1 | Getting Started | [Why Do We Pray?]({{< var urls.u01 >}}) |
| 2 | Getting Started | [Pre-requisites of Salah]({{< var urls.u02 >}}) |
| 3 | The Essential Actions | [Pillars of Salah]({{< var urls.u03 >}}) |
| 4 | The Essential Actions | [Obligatory Acts of Salah]({{< var urls.u04 >}}) |
| 5 | The Essential Actions | [Salah Demonstrated]({{< var urls.u05 >}}) |
| 6 | Beatifying Your Salah | [Rulings Related to Salah]({{< var urls.u06 >}}) |
| 7 | Beatifying Your Salah | [Recommended Actions]({{< var urls.u07 >}}) |
